...
export function Pricing() {
  const planFeatures = [
    "Billing & KOT (+ Dine-in / Takeaway)",
    "Waiter Mobile Ordering System",
    "Live Inventory & Ingredients Tracking",
    "Expense & Staff Salary Management",
    "AI Inventory & Profit Dashboard",
    "80+ Reports & GST Management",
  ...
  return (
    <section id="pricing" className="py-24 px-6 bg-brand-bg scroll-mt-20">
      <div className="max-w-7xl mx-auto border-4 border-brand-text p-8 md:p-16 relative">
        <div className="absolute top-0 right-0 p-4 bg-brand-energy font-display uppercase text-sm border-l-4 border-b-4 border-brand-text font-black">
          BharpetOS Smart Plan
        </div>
        
        <div className="flex flex-col md:flex-row justify-between items-end gap-12">
          <div className="max-w-xl">
            <h2 className="text-6xl md:text-[80px] leading-[0.82] mb-8 font-black uppercase">THE COMPLETE SYSTEM.</h2>
            <ul className="grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-6">
              {planFeatures.map((item) => (
                <li key={item} className="flex items-center gap-4 text-sm font-bold tracking-tight uppercase">
                  <div className="w-6 h-6 border-2 border-brand-text flex items-center justify-center bg-brand-primary shrink-0">
          ...
          <div className="flex flex-col items-end w-full md:w-auto">
            ...
            >
              <span className="text-2xl font-black opacity-30 uppercase tracking-widest">Yearly License</span>
